    ...
    public partial class VocabularyContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ContextTable>(entity =>
            {
                ...
                entity.Property(e => e.WordFormInExample).HasMaxLength(50);
            ...
            modelBuilder.Entity<PriorityTable>(entity =>
            {
                ...
                entity.Property(e => e.Correctly).HasDefaultValueSql("((0))");

                entity.Property(e => e.Uncorrectly).HasDefaultValueSql("((0))");
